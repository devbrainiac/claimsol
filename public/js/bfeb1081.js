    ...
    1989: function (e, t, n) {
      ...
      var l,
        ...
        $ = (e, t, n) =>
          t in e
            ...
            : (e[t] = n),
        A = (e, t) => {
          for (var n in t || (t = {})) M.call(t, n) && $(e, n, t[n]);
          if (S) for (var n of S(t)) L.call(t, n) && $(e, n, t[n]);
          return e;
        },
        E = (e, t) => b(e, k(t)),
        T = (e, t, n) => ($(e, "symbol" != typeof t ? t + "" : t, n), n),
        _ = (e, t, n) =>
          new Promise((r, o) => {
            var l = (e) => {
                try {
      ...
      function F(e, t) {
        let n = {
          ...
          observers: null,
          observerSlots: null,
          comparator: (t = t ? Object.assign({}, W, t) : W).equals || void 0,
        };
        return [
          et.bind(n),
          (e) => ("function" == typeof e && (e = e(n.value)), en(n, e)),
        ];
      }
      function Z(e, t, n) {
        er(eo(e, t, !0, 1));
      ...
      function Q(e) {
        return (
          null === O ||
            (null === O.cleanups ? (O.cleanups = [e]) : O.cleanups.push(e)),
          e
        );
      }
      function J(e, t) {
          ...
          Provider: function (e) {
            ...
            return (
              q(
                () =>
                  (t = G(
                    () => ((O.context = { [n]: e.value }), ee(() => e.children))
                  )),
                void 0
              ),
              t
      ...
      function et() {
        if (this.sources && this.state) {
          if (1 === this.state) er(this);
          else {
            let e = D;
            (D = null), ei(() => ec(this), !1), (D = e);
          }
        }
        if (V) {
          let e = this.observers ? this.observers.length : 0;
          V.sources
            ? (V.sources.push(this), V.sourceSlots.push(e))
            : ((V.sources = [this]), (V.sourceSlots = [e])),
            this.observers
      ...
      function eo(e, t, n, r = 1, o) {
        ...
        return (
          null === O ||
            (O !== P && (O.owned ? O.owned.push(l) : (O.owned = [l]))),
          l
        );
      }
      function el(e) {
        if (0 === e.state) return;
        if (2 === e.state) return ec(e);
        if (e.suspense && G(e.suspense.inFallback))
          return e.suspense.effects.push(e);
        let t = [e];
        for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < K); )
          e.state && t.push(e);
        for (let n = t.length - 1; n >= 0; n--)
          if (1 === (e = t[n]).state) er(e);
          else if (2 === e.state) {
            let n = D;
            (D = null), ei(() => ec(e, t[0]), !1), (D = n);
          }
      }
      function ei(e, t) {
        if (D) return e();
        ...
        try {
          ...
          return (
            (function (e) {
              if ((D && (ea(D), (D = null)), e)) return;
              let t = U;
              (U = null), t.length && ei(() => B(t), !1);
            })(n),
            t
          );
        } catch (e) {
          n || (U = null), (D = null), eh(e);
        }
      }
      function ea(e) {
        for (let t = 0; t < e.length; t++) el(e[t]);
      }
      function es(e) {
        let t,
          n = 0;
        ...
        for (R.context && (R.context = void 0), t = 0; t < n; t++) el(e[t]);
      }
      function ec(e, t) {
        e.state = 0;
      ...
      function eu(e) {
        ...
        if (e.owned) {
          for (t = 0; t < e.owned.length; t++) eu(e.owned[t]);
          e.owned = null;
        }
        if (e.cleanups) {
      ...
      function ew(...e) {
        ...
        for (let n = 0; n < e.length; n++) {
          let r = e[n];
          (t = t || (!!r && I in r)),
            (e[n] = "function" == typeof r ? ((t = !0), Y(r)) : r);
        }
        if (t)
          return new Proxy(
            {
              ...
              has(t) {
                for (let n = e.length - 1; n >= 0; n--)
                  if (t in eC(e[n])) return !0;
                return !1;
              },
              keys() {
                let t = [];
                for (let n = 0; n < e.length; n++)
                  t.push(...Object.keys(eC(e[n])));
                return [...new Set(t)];
              },
            },
            ev
                  ...
                  G(() => {
                    ...
                    if (0 === e)
                      0 !== i &&
                        ...
                        n.fallback &&
                          ((r = [eg]),
                          (o[0] = j((e) => ((l[0] = e), n.fallback()))),
                          (i = 1));
                    else if (0 === i) {
                      for (u = 0, o = Array(e); u < e; u++)
                        (r[u] = s[u]), (o[u] = j(d));
                      i = e;
                    } else {
                      for (
                      ...
                      for (
                        ...
                        (g[C] = o[v]), (f[C] = l[v]), a && (p[C] = a[v]);
                      for (t = new Map(), h = Array(C + 1), u = C; u >= m; u--)
                        (w = s[u]),
                          (c = t.get(w)),
                          (h[u] = void 0 === c ? -1 : c),
                          t.set(w, u);
      ...
      function eb(e) {
        ...
        return Y(
          () => {
            ...
            if (o) {
              let r = e.children,
                l = "function" == typeof r && r.length > 0;
              return (t = n || l), l ? G(() => r(o)) : r;
            }
            return e.fallback;
          },
          void 0,
      ...
      function ek(e) {
        ...
        return Y(
          () => {
            ...
            let a = i.children,
              s = "function" == typeof a && a.length > 0;
            return (t = n || s), s ? G(() => a(l)) : a;
          },
          void 0,
          void 0
        );
      ...
      let eM = new Set([
        ...
        eA = Object.assign(Object.create(null), {
          class: "className",
      ...
      function eB(e, t = {}, n, r) {
        let o = {};
        return (
          r || q(() => (o.children = eU(e, t.children, o.children))),
          q(() => t.ref && t.ref(e)),
          q(() =>
            (function (e, t, n, r, o = {}, l = !1) {
              for (let r in (t || (t = {}), o))
                if (!(r in t)) {
                  if ("children" === r) continue;
                  o[r] = eV(e, r, null, o[r], n, l);
                }
              for (let i in t) {
                if ("children" === i) {
                  r || eU(e, t.children);
      ...
      function eV(e, t, n, r, o, l) {
        ...
        if ("style" === t)
          return (function (e, t, n) {
            let r, o;
            if (!t) return n ? eH(e, "style") : t;
            let l = e.style;
            if ("string" == typeof t) return (l.cssText = t);
            for (o in ("string" == typeof n && (l.cssText = n = void 0),
            n || (n = {}),
            t || (t = {}),
            n))
              null == t[o] && l.removeProperty(o), delete n[o];
            for (o in t)
              (r = t[o]) !== n[o] && (l.setProperty(o, r), (n[o] = r));
            return n;
          })(e, n, r);
        if ("classList" === t)
          return (function (e, t, n = {}) {
            ...
            for (r = 0, o = i.length; r < o; r++) {
              let o = i[r];
              o && "undefined" !== o && !t[o] && (eO(e, o, !1), delete n[o]);
            }
        ...
        if ("ref" === t) l || n(e);
          ...
          (l || n) &&
            ...
            l &&
              (function (e, t = window.document) {
                let n = t[eR] || (t[eR] = new Set());
                for (let r = 0, o = e.length; r < o; r++) {
                  let o = e[r];
                  n.has(o) || (n.add(o), t.addEventListener(o, eD));
                }
              })([o]));
        } else if (
          (s = eL.has(t)) ||
          ...
          let r = o && t.indexOf(":") > -1 && e_[t.split(":")[0]];
          r
            ? null == n
      ...
      function eU(e, t, n, r, o) {
        ...
        if (
          ...
          if (
            (function e(t, n, r, o) {
              ...
              for (let i = 0, a = n.length; i < a; i++) {
                ...
                else if (Array.isArray(a)) l = e(t, a, s) || l;
            ...
            return q(() => (n = eU(e, l, n, r, !0))), () => n;
          if (R.context) {
            if (!l.length) return n;
            for (let e = 0; e < l.length; e++)
              if (l[e].parentNode) return (n = l);
          }
          if (0 === l.length) {
            if (((n = ej(e, n, r)), i)) return n;
          } else
            a
              ? 0 === n.length
                ? eK(e, l, r)
                : (function (e, t, n) {
                    ...
                    for (; i < o || a < l; ) {
                      ...
                      if (o === i) {
                        let t =
                          l < r ? (a ? n[a - 1].nextSibling : n[l - a]) : s;
                        for (; a < l; ) e.insertBefore(n[a++], t);
                      } else if (l === a)
                        for (; i < o; )
                          (c && c.has(t[i])) || t[i].remove(), i++;
                      else if (t[i] === n[l - 1] && n[a] === t[o - 1]) {
          ...
          if (R.context && t.parentNode) return (n = i ? [t] : t);
          if (Array.isArray(n)) {
            if (i) return (n = ej(e, n, r, t));
            ej(e, n, null, t);
          } else
      ...
      function eZ(e) {
        ...
        function o() {
          if (!R.context) return () => e.children;
          {
            let [t, n] = F(!1);
        ...
        if (r instanceof HTMLHeadElement) {
          ...
          j((t) => eN(r, () => (e() ? t() : o()()), null)),
            Q(() => {
              R.context ? queueMicrotask(n) : n();
            });
        } else {
          let l = eF(e.isSVG ? "g" : "div", e.isSVG),
            i = t && l.attachShadow ? l.attachShadow({ mode: "open" }) : l;
      ...
      var ez = (((l = ez || {}).DARK = "DARK"), (l.LIGHT = "LIGHT"), l);
      let eY = { data: "" },
        eG = (e) =>
              ...
              i !== e
                ...
                : ((e) => {
                    let t,
                      n,
                      r = [{}];
                    for (; (t = eQ.exec(e.replace(eJ, ""))); )
                      t[4]
                        ? r.shift()
                        : t[3]
                        ? ((n = t[3].replace(eX, " ").trim()),
                          r.unshift((r[0][n] = r[0][n] || {})))
                        : (r[0][t[1]] = t[2].replace(eX, " ").trim());
                    return r[0];
                  })(e);
            e0[a] = e1(o ? { ["@keyframes " + a]: t } : t, n ? "" : "." + a);
          }
          let s = n && e0.g ? e0.g : null;
          return (
            n && (e0.g = e0[a]),
            (l = e0[a]),
            s
              ? (t.data = t.data.replace(s, l))
              : -1 === t.data.indexOf(l) &&
                (t.data = r ? l + t.data : t.data + l),
            a
          );
        },
        e4 = (e, t, n) =>
      ...
      function e3(e) {
        ...
        return e5(
          n.unshift
            ? n.raw
              ? e4(n, [].slice.call(arguments, 1), t.p)
              : n.reduce(
      ...
      function te(e) {
        ...
        return (...n) => {
          let r = (r) => {
            let o;
            let l = ew(r, { theme: X(e8) }),
              [i, a] = ey(
                ew(l, {
                  get class() {
                    let e = l.class,
                      r = "class" in l && /^go[0-9]+/.test(e);
                    return [
                      e,
                      e3.apply({ target: t.target, o: r, p: l, g: t.g }, n),
                    ]
                      .filter(Boolean)
                      .join(" ");
                  },
            ...
            return (
              "function" == typeof s
                ? (o = s(a))
                : 1 == t.g
                ? eB((o = document.createElement(s)), a)
                : (o = eq(ew({ component: s }, a))),
              o
            );
          };
          return (
            (r.class = (e) =>
              G(() => e3.apply({ target: t.target, p: e, g: t.g }, n))),
            r
          );
        };
      }
      let tt = new Proxy(te, { get: (e, t) => e(t) });
      function tn() {
        let e = te.call({ g: 1 }, "div").apply(null, arguments);
        return function (t) {
          return e(t), null;
        };
      }
      let tr = "tc-root",
        to = "tc-disable-scroll",
        tl = "tc-using-mouse",
        ti = () => (
          document.body.addEventListener("mousedown", () =>
            document.body.classList.add(tl)
          ),
          document.body.addEventListener("keydown", (e) => {
            "Tab" === e.key && document.body.classList.remove(tl);
          }),
          ep(
            tn`
    ${tr} * {
...
`,
      ...
      function th(e, t = "_self") {
        td("openLink", e, t), window.open(e, t, "noopener noreferrer");
      }
      function tg(e) {
        th(e, "_blank");
      }
      function tf(e, t) {
        let n = () => {
            ty("safari") || (tw("android") && ty("firefox")) || t();
          },
          r = setTimeout(() => n(), 200);
      ...
      function tv() {
        if (
          ...
          return localStorage;
        if (void 0 !== y && null != y.versions && null != y.versions.node)
          throw new tu(
      ...
      function tC() {
        var e, t, n;
        let r, o;
        let l = new v().getResult(),
          i = null == (e = l.os.name) ? void 0 : e.toLowerCase(),
          a = null == (t = l.device.model) ? void 0 : t.toLowerCase();
        switch (!0) {
          case "ipad" === a:
            r = "ipad";
            break;
          ...
          case "linux" === i:
            r = "linux";
            break;
          case null == i ? void 0 : i.includes("windows"):
            r = "windows";
        }
        let s = null == (n = l.browser.name) ? void 0 : n.toLowerCase();
        switch (!0) {
          case "chrome" === s:
            o = "chrome";
            break;
        ...
        return { os: r, browser: o };
      }
      function tw(...e) {
        return e.includes(tC().os);
      }
      function ty(...e) {
        return e.includes(tC().browser);
      }
      function tx(e, t) {
      ...
      class tb {
        constructor() {
          T(this, "localStorage"),
            T(this, "storageKey", "ton-connect-ui_wallet-info"),
            (this.localStorage = tv());
        }
        setWalletInfo(e) {
      ...
      class tk {
        constructor() {
          T(this, "localStorage"),
            T(this, "storageKey", "ton-connect-ui_preferred-wallet"),
            (this.localStorage = tv());
        }
      ...
      class tS {
        constructor() {
          T(this, "localStorage"),
            T(this, "storageKey", "ton-connect-ui_last-selected-wallet-info"),
            (this.localStorage = tv());
        }
      ...
      let [tM, tL] = F({ status: "closed", closeReason: null }),
        t$ = Y(() => "opened" === tM().status),
        [tA, tE] = F({ status: "closed", closeReason: null }),
        tT = Y(() => "opened" === tA().status),
        t_ = Y(() => {
          let e = tA();
          return "opened" === e.status ? e.walletInfo : null;
        }),
        tR = "undefined" != typeof window ? new tS() : void 0,
        [tI, tH] = F(
          (null == tR ? void 0 : tR.getLastSelectedWalletInfo()) || null
        ),
        tW = (e) => {
          tR || (tR = new tS()),
            e
              ? tR.setLastSelectedWalletInfo(e)
              : tR.removeLastSelectedWalletInfo(),
            tH(e);
        },
        [tB, tP] = F(null),
        tN = {
          en: tO({
            ...
            walletModal: {
              ...
              mobileConnectionModal: {
                showQR: "Show QR Code",
                scanQR:
                  "Scan the\xa0QR code below with your phone’s\xa0or\xa0{{ name }}’s camera",
              ...
              desktopConnectionModal: {
                scanQR:
                  "Scan the\xa0QR code below with your phone’s\xa0or\xa0{{ name }}’s camera",
                continueInExtension:
                  "Continue in\xa0{{ name }} browser extension…",
                dontHaveExtension:
                  "Seems you don't have installed {{ name }}\xa0browser\xa0extension",
                getWallet: "Get {{ name }}",
          ...
          ru: tO({
            ...
            walletModal: {
              ...
              mobileUniversalModal: {
                ...
                openWalletOnTelegramOrSelect:
                  "Подключите Wallet в\xa0Telegram или\xa0выберете кошелёк для\xa0подключения",
              ...
              mobileConnectionModal: {
                ...
                scanQR:
                  "Отсканируйте QR-код ниже камерой в\xa0приложении {{ name }}, или\xa0камерой телефона",
              ...
              desktopConnectionModal: {
                scanQR:
                  "Отсканируйте QR-код ниже камерой в\xa0приложении {{ name }}, или\xa0камерой телефона",
                continueInExtension:
                  "Откройте браузерное расширение {{ name }}",
                dontHaveExtension:
                  "Похоже, у вас не\xa0установлено браузерное\xa0расширение\xa0{{ name }}",
              ...
              if ("$" === o[0]) {
                ...
                t.forEach((e) => {
                  if (e in l) l = l[e];
                    ...
                    throw Error(
                      `Cannot parse translations: there is no property ${e} in translation`
                    );
                }),
                  (n[r] = l);
              }
      ...
      let tV = J(),
        tD = Symbol("store-raw"),
        tU = Symbol("store-node"),
        tK = Symbol("store-name");
      function tj(e, t) {
        let n = e[I];
        if (
          !n &&
          (Object.defineProperty(e, I, { value: (n = new Proxy(e, tQ)) }),
          !Array.isArray(e))
        ) {
          let t = Object.keys(e),
      ...
      function tZ(e, t = new Set()) {
        let n, r, o, l;
        if ((n = null != e && e[tD])) return n;
        if (!tF(e) || t.has(e)) return e;
        if (Array.isArray(e)) {
          Object.isFrozen(e) ? (e = e.slice(0)) : t.add(e);
          for (let n = 0, l = e.length; n < l; n++)
            (r = tZ((o = e[n]), t)) !== o && (e[n] = r);
        } else {
          Object.isFrozen(e) ? (e = Object.assign({}, e)) : t.add(e);
          let n = Object.keys(e),
            i = Object.getOwnPropertyDescriptors(e);
          for (let a = 0, s = n.length; a < s; a++)
            i[(l = n[a])].get || (r = tZ((o = e[l]), t)) === o || (e[l] = r);
        }
        return e;
      }
      function tq(e) {
        let t = e[tU];
        return t || Object.defineProperty(e, tU, { value: (t = {}) }), t;
      }
      function tz(e, t, n) {
        return e[t] || (e[t] = tG(n));
      }
      ...
      function tG(e) {
        let [t, n] = F(e, { equals: !1, internal: !0 });
        return (t.$ = n), t;
      }
      let tQ = {
        get(e, t, n) {
          if (t === tD) return e;
          if (t === I) return n;
          if (t === H) return tY(e), n;
          let r = tq(e),
            o = r.hasOwnProperty(t),
            l = o ? r[t]() : e[t];
          if (t === tU || "__proto__" === t) return l;
          if (!o) {
                ...
                : (function e(t, n, r = []) {
                    ...
                    if (n.length > 1) {
                      ...
                      if (a && "object" === i) {
                        ...
                        for (let o = l; o <= i; o += a) e(t, [o].concat(n), r);
                        return;
                      }
                      if (n.length > 1) {
                        e(t[o], n, [o].concat(r));
                    ...
                    let i = n[0];
                    ("function" != typeof i || (i = i(l, r)) !== l) &&
                      (void 0 !== o || void 0 != i) &&
                      ((i = tZ(i)),
                      void 0 === o || (tF(l) && tF(i) && !Array.isArray(i))
                        ? tX(l, i)
                        : tJ(t, o, i));
                  })(n, e);
            }, !1);
      ...
      function t4(e, t) {
        return e
          ? C(t, e, { arrayMerge: (e, t, n) => t, isMergeableObject: t5 })
          : t;
      }
      let [t3, t9] = t1({ theme: ez.LIGHT, colors: t0, borderRadius: "m" }),
        t8 = {
          [ez.LIGHT]: t0,
          [ez.DARK]: {
            constant: { black: "#000000", white: "#FFFFFF" },
        ...
        t6 = { [ez.LIGHT]: void 0, [ez.DARK]: void 0 };
      function t7(e, t) {
        t &&
          ((t6[ez.DARK] = t4(t[ez.DARK], t6[ez.DARK])),
          (t6[ez.LIGHT] = t4(t[ez.LIGHT], t6[ez.LIGHT]))),
          t9({ theme: e, colors: t4(t6[e], t8[e]) });
      }
      let ne = tt.div`
...
`,
      ...
      try {
        ...
        nn = (function (e) {
          ...
          if (0 > e.indexOf("=") && 0 > e.indexOf("?"))
            return (t._path = nd(e)), t;
          let n = e.indexOf("?");
          if (n >= 0) {
            let r = e.substr(0, n);
            (t._path = nd(r)), (e = e.substr(n + 1));
          }
          let r = (function (e) {
            let t,
              n,
      ...
      let nr = "unknown";
      if (
        ((null == nn ? void 0 : nn.tgWebAppPlatform) &&
          (nr = null != (s = nn.tgWebAppPlatform) ? s : "unknown"),
        "unknown" === nr)
      ) {
        let e = tm();
        nr =
          ...
          (d =
            null ==
            (u =
              null == (c = null == e ? void 0 : e.Telegram) ? void 0 : c.WebApp)
              ? void 0
              : u.platform)
            ? d
            : "unknown";
      ...
      let no = "6.0";
      if (
        ((null == nn ? void 0 : nn.tgWebAppVersion) &&
          (no = nn.tgWebAppVersion),
        !no)
      ) {
        let e = tm();
        no =
          ...
          (f =
            null ==
            (g =
              null == (h = null == e ? void 0 : e.Telegram) ? void 0 : h.WebApp)
              ? void 0
              : g.version)
            ? f
            : "6.0";
      ...
      function nl(...e) {
        return e.includes(nr);
      }
      function ni() {
        var e;
        return (
          "unknown" !== nr ||
          !!(null == (e = tm()) ? void 0 : e.TelegramWebviewProxy)
        );
      }
      function na() {
        nu("web_app_expand", {});
      ...
      function ns(e, t) {
        ...
        if ("http:" !== n.protocol && "https:" !== n.protocol) {
          if (t) return t();
          throw new tu(`Url protocol is not supported: ${n}`);
        }
        if ("t.me" !== n.hostname) {
          if (t) return t();
          throw new tu(`Url host is not supported: ${n}`);
        }
        ...
        (function (e, t) {
          ...
          let i = e.replace(/^\s+|\s+$/g, "").split("."),
            a = t.replace(/^\s+|\s+$/g, "").split(".");
          for (r = 0, n = Math.max(i.length, a.length); r < n; r++)
            if ((o = parseInt(i[r]) || 0) !== (l = parseInt(a[r]) || 0)) {
              if (o > l) return 1;
              return -1;
            }
          return 0;
        })(no, "6.1") >= 0
          ? nu("web_app_open_tg_link", { path_full: r })
          : tg("https://t.me" + r);
      }
      function nc() {
        try {
      ...
      function nu(e, t) {
        try {
          ...
          if (void 0 !== n.TelegramWebviewProxy)
            ...
            td("postEvent", e, t), n.parent.postMessage(r, "*");
          } else throw new tu("Can't post event to TMA");
        } catch (e) {
          !(function (...e) {
            try {
      ...
      function ng(e) {
        ...
        switch (e) {
          ...
          case "tablet":
            return n > nh.mobile;
          default:
            return n <= nh.mobile || tw("ios", "android", "ipad");
        }
      }
      function nf(e) {
        switch (e) {
          case "mobile":
            return `@media (max-width: ${nh.mobile}px)`;
          case "tablet":
            return `@media (max-width: ${nh.tablet}px) (min-width: ${nh.mobile}px)`;
          default:
            return `@media (min-width: ${nh.tablet}px)`;
        }
      }
      let np = "@media (hover: none)",
        nm = "@media not all and (hover: none)",
        nv = { m: "100vh", s: "8px", none: "0" },
        nC = { s: 0.02, m: 0.04 },
        nw = tt.button`
    ...
    padding-left: ${(e) =>
      e.leftIcon && "flat" !== e.appearance ? "12px" : "16px"};
    padding-right: ${(e) =>
      e.rightIcon && "flat" !== e.appearance ? "12px" : "16px"};
    border: none;
    ...
    ${nm} {
        &:hover {
            transform: ${(e) =>
              e.disabled ? "unset" : `scale(${1 + nC[e.scale]})`};
        }
    }
    ...
    ${np} {
        &:active {
            transform: ${(e) =>
              e.disabled ? "unset" : `scale(${1 - 2 * nC[e.scale]})`};
        }
    }
`;
      function ny(e) {
        let t = G(() => Object.keys(e).filter((e) => e.startsWith("data-"))),
          [n] = ey(e, t);
        return n;
      }
      let nx = (e) => {
      ...
      let nk = (e) => {
        ...
        function m(t, n) {
          let l = f().exitClass.split(" "),
            i = f().exitActiveClass.split(" "),
            a = f().exitToClass.split(" ");
          if (!n.parentNode) return s();
          function s(l) {
            (l && l.target !== n) ||
          ...
          d && d(n),
            ...
            n.classList.add(...i),
            nb(() => {
              n.classList.remove(...l), n.classList.add(...a);
            }),
            h && h(n, () => s()),
            (!h || h.length < 2) &&
      ...
      let nM = (e) => {
          ...
          return (
            Z(() => {
              let e = t(),
                ...
                v = n().enterToClass.split(" "),
                C = n().exitClass.split(" "),
                w = n().exitActiveClass.split(" "),
                y = n().exitToClass.split(" ");
              for (let t = 0; t < e.length; t++) {
                let n = e[t];
                if (!h && !f.has(n)) {
                  let e = function (t) {
              ...
              for (let e = 0; e < d.length; e++) {
                ...
                if (!g.has(t) && t.parentNode) {
                  ...
                  c.splice(e, 0, t),
                    ...
                    t.classList.add(...w),
                    nb(() => {
                      t.classList.remove(...C), t.classList.add(...y);
                    }),
                    a && a(t, () => n()),
                    (!a || a.length < 2) &&
                      (t.addEventListener("transitionend", n),
            ...
            z((e) => {
              ...
              return (
                (t.forEach((t) => {
                  let n;
                  (n = e.get(t))
                    ? n.new && ((n.new = !1), (n.newPos = nS(t)))
                    : e.set(t, (n = { pos: nS(t), new: !h })),
                    n.new &&
                      t.addEventListener(
                        "transitionend",
                        () => {
                          (n.new = !1), t.parentNode && (n.newPos = nS(t));
                        },
                        { once: !0 }
                      ),
                ...
                h)
                  ...
                  : (t.forEach((t) => {
                      ...
                      if (l || i) {
                        n.moved = !0;
                        let e = t.style;
                        (e.transform = `translate(${l}px,${i}px)`),
        ...
        nE = { left: 0, top: 90, right: 180, bottom: 270 },
        nT = (e) => {
          let t = e7(),
    ...
    `,
            {
              ...
              get children() {
                let e = nA.cloneNode(!0);
                return q(() => eH(e, "fill", n())), e;
              },
            }
          );
        },
        ...
        nR = (e) => {
          let t = e7(),
            n = () => e.fill || t.colors.icon.secondary;
          return (() => {
            let e = n_.cloneNode(!0),
              t = e.firstChild;
            return q(() => eH(t, "fill", n())), e;
          })();
        },
        nI = tt.button`
    padding: 0;
...
`,
        nD = tt(nH)`
    background-color: ${(e) => ta(e.theme.colors.icon.secondary, 0.12)};
`;
      class nU {
        constructor() {
      ...
      let nK = class {
        constructor() {
          T(this, "currentTime", 0),
            T(this, "playbackRate", 1),
            T(this, "startTime", null),
            T(this, "timeline", new nU()),
            T(this, "finished", Promise.resolve(this)),
            T(this, "effect", null),
            T(this, "id", ""),
            T(this, "pending", !1),
            T(this, "playState", "finished"),
            T(this, "replaceState", "active"),
            T(this, "ready", Promise.resolve(this)),
            T(this, "oncancel", null),
            T(this, "onfinish", null),
            T(this, "onremove", null);
        }
        static create() {
          return (
            nK._instance ||
      ...
      function nj(e, t, n) {
        return "animate" in e ? e.animate(t, n) : nK.create();
      }
      T(nK, "_instance", null);
      let nF = eI("<div></div>"),
        nZ = function (e, t) {
          ...
          document.body.addEventListener("click", n),
            Q(() => document.body.removeEventListener("click", n));
        },
        nq = function (e, t) {
          let n = (e) => {
            var n, r;
            "Escape" === e.key &&
              (null == (n = document.activeElement) || n.blur(),
              null == (r = t()) || r());
          };
          document.body.addEventListener("keydown", n),
            Q(() => document.body.removeEventListener("keydown", n));
        },
        nz = function (e, t) {
          let { isEnabled: n, onClose: r } = t();
          if (!n || "android" !== tC().os) return;
          window.history.pushState(n$, "");
          let o = (e) => {
            e.preventDefault(), r();
          };
          window.addEventListener("popstate", o, { once: !0 }),
            Q(() => {
              window.removeEventListener("popstate", o),
                tp(() => {
                  var e;
                  (null == (e = window.history.state) ? void 0 : e[nL]) ===
        ...
        nY = (e) => {
          ...
          return (
            ...
            ep(nk, {
              onBeforeEnter: (e) => {
                let t = ng("mobile") ? 200 : 100;
                nj(e, [{ opacity: 0 }, { opacity: 1 }], { duration: t }),
                  ng("mobile") &&
                    nj(
                      e.firstElementChild,
                      [
              ...
              onExit: (e, t) => {
                let n = ng("mobile") ? 200 : 100,
                  r = nj(e, [{ opacity: 1 }, { opacity: 0 }], { duration: n });
                if (ng("mobile")) {
                  let o = nj(
                    e.firstElementChild,
                    [
              ...
              get children() {
                return ep(eb, {
                  ...
                  get children() {
                    return ep(
                      nB,
                      ew({ "data-tc-modal": "true" }, n, {
                        get children() {
                          let n = nF.cloneNode(!0);
                          return (
                            eP(nz, n, () => ({
        ...
        nG = { m: "22px", s: "12px", none: "0" },
        nQ = { m: "18px", s: "8px", none: "0" },
        nJ = tt.div`
    display: grid;
...
`,
        n2 = { m: "16px", s: "12px", none: "0" },
        n5 = { m: "12px", s: "8px", none: "0" },
        n4 = tt.div`
    width: 52px;
    height: 52px;
...
`;
      ...
      ((i = (function () {
        var e,
          ...
          a = function (e, t) {
            var n = e,
              ...
              b = function () {
                for (
                  var e = d.getPatternPosition(n), t = 0;
                  t < e.length;
                  t += 1
                )
              ...
              k = function (e) {
                for (var t = d.getBCHTypeNumber(n), r = 0; r < 18; r += 1) {
                  var i = !e && ((t >> r) & 1) == 1;
                  o[Math.floor(r / 3)][(r % 3) + l - 8 - 3] = i;
                }
                for (var r = 0; r < 18; r += 1) {
                  var i = !e && ((t >> r) & 1) == 1;
                  o[(r % 3) + l - 8 - 3][Math.floor(r / 3)] = i;
                }
              },
              M = function (e, t) {
                for (
                  var n = (r << 3) | t, i = d.getBCHTypeInfo(n), a = 0;
                  a < 15;
                  a += 1
                ) {
                  var s = !e && ((i >> a) & 1) == 1;
              ...
              $ = function (e, t) {
                for (
                  ...
                  var s = t[a].dataCount,
                    c = t[a].totalCount - s;
                  (r = Math.max(r, s)), (o = Math.max(o, c)), (l[a] = Array(s));
                  for (var u = 0; u < l[a].length; u += 1)
                    l[a][u] = 255 & e.getBuffer()[u + n];
                  n += s;
                  var h = d.getErrorCorrectPolynomial(c),
                    f = g(l[a], h.getLength() - 1).mod(h);
                  i[a] = Array(h.getLength() - 1);
                  for (var u = 0; u < i[a].length; u += 1) {
                    var p = u + f.getLength() - i[a].length;
                    i[a][u] = p >= 0 ? f.getAt(p) : 0;
                  }
                }
                for (var m = 0, u = 0; u < t.length; u += 1)
                  m += t[u].totalCount;
                for (var v = Array(m), C = 0, u = 0; u < r; u += 1)
                  for (var a = 0; a < t.length; a += 1)
                    u < l[a].length && ((v[C] = l[a][u]), (C += 1));
                for (var u = 0; u < o; u += 1)
                  for (var a = 0; a < t.length; a += 1)
                    u < i[a].length && ((v[C] = i[a][u]), (C += 1));
                return v;
              },
              A = function (e, t, n) {
                for (
                  var r = f.getRSBlocks(e, t), o = p(), l = 0;
                  l < n.length;
                  l += 1
                ) {
                  var i = n[l];
                  o.put(i.getMode(), 4),
                    o.put(i.getLength(), d.getLengthInBits(i.getMode(), e)),
                    i.write(o);
                }
                for (var a = 0, l = 0; l < r.length; l += 1)
                  a += r[l].dataCount;
            ...
            (s.addData = function (e, t) {
              ...
              (s.make = function () {
                if (n < 1) {
                  for (var e = 1; e < 40; e++) {
                    for (
                      var t = f.getRSBlocks(e, r), o = p(), l = 0;
                      l < a.length;
                      l++
                    ) {
                      var i = a[l];
                    ...
                    for (var s = 0, l = 0; l < t.length; l++)
                      s += t[l].dataCount;
                    if (o.getLengthInBits() <= 8 * s) break;
                  }
                  n = e;
                }
                u(!1, y());
              ...
              (s.createSvgTag = function (e, t, n, r) {
                ...
                for (
                  ...
                  for (l = 0, a = i * e + t; l < s.getModuleCount(); l += 1)
                    s.isDark(i, l) && (d += "M" + (l * e + t) + "," + a + c);
              ...
              (s.createDataURL = function (e, t) {
                ...
                return S(n, n, function (t, n) {
                  ...
                  var l = Math.floor((t - r) / e),
                    i = Math.floor((n - r) / e);
                  return s.isDark(i, l) ? 0 : 1;
                });
              }),
            ...
            var E = function (e) {
              ...
              T = function (e) {
                  ...
                  for (
                    ...
                    (l = "█"),
                      a <= n &&
                        ...
                        a <= t &&
                        t < c &&
                        s.isDark(r, Math.floor((n - a) / 1)) &&
                        (l = " "),
                      a <= n &&
                      n < c &&
                      a <= t + 1 &&
                      t + 1 < c &&
                      s.isDark(o, Math.floor((n - a) / 1))
                        ? (l += " ")
                        : (l += "█"),
                      (h += e < 1 && t + 1 >= c ? d[l] : u[l]);
                  h += "\n";
                ...
                return i % 2 && e > 0
                  ? h.substring(0, h.length - i - 1) + Array(i + 1).join("▀")
                  : h.substring(0, h.length - 1);
              };
            return (
              (s.createASCII = function (e, t) {
                if ((e = e || 1) < 2) return T(t);
        ...
        var s = {
          ...
          d =
            ...
            (t.getBCHTypeInfo = function (e) {
              for (var t = e << 10; n(t) - n(1335) >= 0; )
                t ^= 1335 << (n(t) - n(1335));
              return ((e << 10) | t) ^ 21522;
            }),
            (t.getBCHTypeNumber = function (e) {
              for (var t = e << 12; n(t) - n(7973) >= 0; )
                t ^= 7973 << (n(t) - n(7973));
              return (e << 12) | t;
            }),
            ...
            (t.getLostPoint = function (e) {
              for (var t = e.getModuleCount(), n = 0, r = 0; r < t; r += 1)
                for (var o = 0; o < t; o += 1) {
                  for (var l = 0, i = e.isDark(r, o), a = -1; a <= 1; a += 1)
                    if (!(r + a < 0) && !(t <= r + a))
                      for (var s = -1; s <= 1; s += 1)
                        o + s < 0 ||
                          t <= o + s ||
            ...
            t),
          h = (function () {
            for (var e = Array(256), t = Array(256), n = 0; n < 8; n += 1)
              e[n] = 1 << n;
        ...
        function g(e, t) {
          ...
          return (
            ...
            (r.multiply = function (e) {
              for (
                var t = Array(r.getLength() + e.getLength() - 1), n = 0;
                n < r.getLength();
                n += 1
              )
                for (var o = 0; o < e.getLength(); o += 1)
                  t[n + o] ^= h.gexp(h.glog(r.getAt(n)) + h.glog(e.getAt(o)));
              return g(t, 0);
            }),
            (r.mod = function (e) {
              if (r.getLength() - e.getLength() < 0) return r;
              for (
                var t = h.glog(r.getAt(0)) - h.glog(e.getAt(0)),
                  n = Array(r.getLength()),
                  o = 0;
                o < r.getLength();
                o += 1
        ...
        var f =
            ...
            (l.getRSBlocks = function (e, t) {
              ...
              for (var r = n.length / 3, l = [], a = 0; a < r; a += 1)
                for (
                  var s = n[3 * a + 0],
                    c = n[3 * a + 1],
                    u = n[3 * a + 2],
          ...
          x = function () {
            ...
            return (
              ...
              (o.flush = function () {
                if ((t > 0 && (l(e << (6 - t)), (e = 0), (t = 0)), n % 3 != 0))
                  for (var o = 3 - (n % 3), i = 0; i < o; i += 1) r += "=";
              }),
              (o.toString = function () {
                return r;
              }),
            ...
            (r.setPixel = function (t, r, o) {
              ...
              (r.write = function (n) {
                ...
                for (var o = 0; r.length - o > 255; )
                  n.writeByte(255), n.writeBytes(r, o, 255), (o += 255);
                n.writeByte(r.length - o),
                  n.writeBytes(r, o, r.length - o),
                  n.writeByte(0),
                  n.writeString(";");
              });
            var o = function (e) {
                var t = 0,
                  ...
                  r = {};
                return (
                  (r.write = function (r, o) {
                    if (r >>> o != 0) throw "length over";
                    for (; t + o >= 8; )
                      e.writeByte(255 & ((r << t) | n)),
                        (o -= 8 - t),
                        (r >>>= 8 - t),
                        (n = 0),
                        (t = 0);
              ...
              l = function (e) {
                for (
                  var t = 1 << e, r = (1 << e) + 1, l = e + 1, a = i(), s = 0;
                  s < t;
                  s += 1
                )
                ...
                for (d += 1; d < n.length; ) {
                  var g = String.fromCharCode(n[d]);
                  (d += 1),
                    a.contains(h + g)
                      ? (h += g)
                      : (u.write(a.indexOf(h), l),
                        4095 > a.size() &&
                          (a.size() == 1 << l && (l += 1), a.add(h + g)),
                        (h = g));
                }
                return (
                  u.write(a.indexOf(h), l),
          ...
          S = function (e, t, n) {
            for (var r = k(e, t), o = 0; o < t; o += 1)
              for (var l = 0; l < e; l += 1) r.setPixel(l, o, n(l, o));
            var i = y();
            r.write(i);
            for (var a = x(), s = i.toByteArray(), c = 0; c < s.length; c += 1)
              a.writeByte(s[c]);
        ...
        return _(this, null, function* () {
          try {
            if (!(null == navigator ? void 0 : navigator.clipboard))
              throw new tu("Clipboard API not available");
      ...
      let rr = eI("<div></div>"),
        ro = (e) => {
          ...
          z(() => {
            ...
            let l = t.firstElementChild.clientWidth,
              i = Math.round((256 / l) * 1e5) / 1e5;
            if (r) {
              let e = 4 * Math.ceil(60 / (4 * i)),
                t = ts(4 * Math.ceil((l - e) / 8));
              (r.style.top = t),
                (r.style.left = t),
                (r.style.height = ts(e)),
                (r.style.width = ts(e)),
              ...
              return [
                ep(n9, {
                  ...
                  get children() {
                    return [
                      (() => {
                        let e = rr.cloneNode(!0),
                          n = t;
                        return "function" == typeof n ? eP(n, e) : (t = e), e;
                      })(),
                      ep(eb, {
                        get when() {
                          return e.imageUrl;
      ...
      var rl = (e, t, n) => {
        ...
        ri = (e, t, n = /{{(.*?)}}/g) => e.replace(n, (e, n) => rl(t, n, "")),
        ra = (
          e = {},
...
`,
        rd = (e) => {
          ...
          let n = e7(),
            ...
            l = ew(
              { fontSize: "14px", fontWeight: "510", lineHeight: "130%" },
              e
            );
          return (
            z(() => {
              t &&
                "unset" !== l.cursor &&
                "pointer" !== getComputedStyle(t).cursor &&
            ...
            ep(ru, {
              ...
              get children() {
                var i;
                return Y(() => !!l.translationKey)()
                  ? r(
                      l.translationKey,
                      l.translationValues,
                      null == (i = l.children) ? void 0 : i.toString()
                    )
                  : l.children;
              },
            })
...
`,
        rS = (e) => {
          ...
          return ep(rk, {
            ...
            get children() {
              var n;
              return Y(() => !!e.translationKey)()
                ? t(
                    e.translationKey,
                    e.translationValues,
                    null == (n = e.children) ? void 0 : n.toString()
                  )
                : e.children;
            },
          });
              ...
              q(
                (r) => {
                  let o = n(),
                    l = n();
                  return (
                    o !== r._v$ && eH(e, "fill", (r._v$ = o)),
                    l !== r._v$2 && eH(t, "fill", (r._v$2 = l)),
                    r
                  );
                },
                      ...
                      return (
                        q(
                          (i) => {
                            ...
                            return (
                              a !== i._v$ && eH(n, "class", (i._v$ = a)),
                              s !== i._v$2 && eH(o, "fill", (i._v$2 = s)),
                              c !== i._v$3 && eH(l, "stroke", (i._v$3 = c)),
                              i
                            );
                          },
    ...
    `;
                        ...
                        q(
                          (o) => {
                            let i = w(l, e.class),
                              a = r();
                            return (
                              i !== o._v$ && eH(t, "class", (o._v$ = i)),
                              a !== o._v$2 && eH(n, "fill", (o._v$2 = a)),
                              o
                            );
                          },
                          { _v$: void 0, _v$2: void 0 }
        ...
        rZ = () => {
          let e = e7(),
            t = () =>
              e.theme === ez.DARK
                ? e.colors.constant.white
                : e.colors.constant.black;
          return (() => {
            let e = rF.cloneNode(!0),
              n = e.firstChild.nextSibling.nextSibling;
            return q(() => eH(n, "fill", t())), e;
          })();
        },
        rq = eI(
              ...
              q(
                (o) => {
                  let l = e.class,
                    i = n();
                  return (
                    l !== o._v$ && eH(t, "class", (o._v$ = l)),
                    i !== o._v$2 && eH(r, "fill", (o._v$2 = i)),
                    o
                  );
                },
                { _v$: void 0, _v$2: void 0 }
        ...
        od = { m: "16px", s: "12px", none: "0" },
        oh = { m: "6px", s: "6px", none: "0" },
        og = tt.div`
    width: 60px;
    height: 60px;
    padding: 8px;
        ...
        oC = (e) => {
          let [t] = rc(),
            n = () =>
              e.wallet.appName === om
                ? void 0
                : "isPreferred" in e.wallet && e.wallet.isPreferred
...
`,
        [ox, ob] = F((null == (p = tm()) ? void 0 : p.innerHeight) || 0);
      tm() && window.addEventListener("resize", () => ob(window.innerHeight));
      let [ok, oS] = F(ng("mobile")),
        oM = () => oS(ng("mobile"));
      tm() &&
        (window.addEventListener("resize", () => oM()),
        window.addEventListener("load", () => oM(), { once: !0 }));
      let oL = (e) => {
          let [t, n] = F(!1),
            r = () => (ok() ? 150 : 200),
            o = () =>
              void 0 !== e.maxHeight ? `${e.maxHeight}px` : `${ox() - r()}px`;
          return [
            ep(oy, {
              get isShown() {
                return t();
...
`,
              ...
              q(
                (e) => {
                  let o = n(),
                    l = n();
                  return (
                    o !== e._v$ && eH(t, "fill", (e._v$ = o)),
                    l !== e._v$2 && eH(r, "fill", (e._v$2 = l)),
                    e
                  );
                },
                { _v$: void 0, _v$2: void 0 }
        ...
        oH = { m: "8px", s: "4px", none: "0" },
        oW = { m: "16px", s: "8px", none: "0" },
        oB = tt.div`
    width: 256px;
...
`,
        oX = { timeout: 4500 },
        [o1, o0] = F(null),
        o2 = eI('<div data-tc-list-notifications="true"></div>'),
        o5 = tt(nx)`
    background-color: ${(e) => e.theme.colors.connectButton.background};
    color: ${(e) => e.theme.colors.connectButton.foreground};
    box-shadow: ${(e) =>
      `0 4px 24px ${ta(e.theme.colors.constant.black, 0.16)}`};
          ...
          let t = X(oE),
            ...
            o = () =>
              _(void 0, null, function* () {
                let e = (0, m.mb)(
                  t.account.address,
                  t.account.chain === m.sX.TESTNET
                );
                yield rn(e), r(!0), setTimeout(() => r(!1), 1e3);
              }),
            l = () => {
            ...
            return (
              z(
                (function (e, t, n) {
                  ...
                  o0(e),
                    r((e) =>
                      e.filter((e) => "confirm-transaction" !== e.action)
                    );
                  let o = { action: e.name };
                  r((e) => [...e, o]);
                  let i = setTimeout(() => {
...
`;
      ...
      function lt(e, t, n) {
        let r,
          ...
          i = o.x + o.width / 2 - l.width / 2,
          a = o.y + o.height / 2 - l.height / 2,
          s = ["top", "bottom"].includes(le(t)) ? "x" : "y",
          c = "y" === s ? "height" : "width",
          u = o[c] / 2 - l[c] / 2,
          d = le(t),
          h = "x" === s;
        switch (d) {
          case "top":
            r = { x: i, y: o.y - l.height };
            break;
          case "bottom":
            r = { x: i, y: o.y + o.height };
            break;
          case "right":
            r = { x: o.x + o.width, y: a };
            break;
      ...
      let ln = (e, t, n) =>
        _(void 0, null, function* () {
          ...
          return { x: u, y: d, placement: h, strategy: o, middlewareData: g };
        });
      function lr(e) {
        return E(A({}, e), {
          top: e.y,
      ...
      function la() {
        ...
        return e && Array.isArray(e.brands)
          ? (o = e.brands.map((e) => e.brand + "/" + e.version).join(" "))
          : navigator.userAgent;
      }
      function ls(e) {
      ...
      function ld(e) {
        ...
        let t = lo(e).ShadowRoot;
        return e instanceof t || e instanceof ShadowRoot;
      }
      function lh(e) {
        let { overflow: t, overflowX: n, overflowY: r, display: o } = ll(e);
        return (
      ...
      function ly(e) {
        let t =
          !lc(e) && e.contextElement ? e.contextElement : lc(e) ? e : null;
        if (!t) return lw;
        ...
        if ("border-box" !== r.boxSizing)
          return ls(t)
            ? {
                x: (t.offsetWidth > 0 && lC(n.width) / t.offsetWidth) || 1,
                y: (t.offsetHeight > 0 && lC(n.height) / t.offsetHeight) || 1,
              }
            : lw;
        let o = n.width / parseFloat(r.width),
          l = n.height / parseFloat(r.height);
        return (
      ...
      function lx(e, t, n, r) {
        ...
        let s = e.getBoundingClientRect(),
          c = lw;
        t && (r ? lc(r) && (c = ly(r)) : (c = ly(e)));
        let u = lc(e) ? lo(e) : window,
          d = !lf() && n,
          h =
            (s.left +
              (d &&
              null !=
                (o = null == (l = u.visualViewport) ? void 0 : l.offsetLeft)
                ? o
                : 0)) /
            c.x,
          g =
            (s.top +
              (d &&
              null !=
                (i = null == (a = u.visualViewport) ? void 0 : a.offsetTop)
                ? i
                : 0)) /
            c.y,
          f = s.width / c.x,
      ...
      function lS(e) {
        return lx(lb(e)).left + lk(e).scrollLeft;
      }
      function lM(e) {
        if ("html" === li(e)) return e;
        let t =
          e.assignedSlot || e.parentNode || (ld(e) ? e.host : null) || lb(e);
        return ld(t) ? t.host : t;
      }
      function lL(e) {
        return ls(e) && "fixed" !== ll(e).position ? e.offsetParent : null;
      }
      function l$(e) {
        let t = lo(e),
          n = lL(e);
        for (
          ;
          n &&
          ["table", "td", "th"].includes(li(n)) &&
          "static" === ll(n).position;

        )
          n = lL(n);
        return n &&
          ("html" === li(n) ||
            ("body" === li(n) && "static" === ll(n).position && !lg(n)))
          ? t
          : n ||
              (function (e) {
                let t = lM(e);
      ...
      function lA(e, t) {
        ...
        let r = (function e(t) {
            let n = lM(t);
            return lp(n) ? t.ownerDocument.body : ls(n) && lh(n) ? n : e(n);
          })(e),
          o = r === (null == (n = e.ownerDocument) ? void 0 : n.body),
          l = lo(r);
        return o
          ? t.concat(l, l.visualViewport || [], lh(r) ? r : [])
          : t.concat(r, lA(r));
      }
      function lE(e, t, n) {
        return "viewport" === t
          ...
          : lr(
              (function (e) {
                ...
                let n = lb(e),
                  ...
                  s = -r.scrollTop;
                return (
                  "rtl" === ll(o || n).direction &&
                    (a += lv(n.clientWidth, o ? o.clientWidth : 0) - l),
      ...
      let lT = {
        getClippingRect: function (e) {
          let { element: t, boundary: n, rootBoundary: r, strategy: o } = e,
            l = [
              ...("clippingAncestors" === n
                ? (function (e, t) {
                    let n = t.get(e);
                    if (n) return n;
                    let r = lA(e).filter((e) => lc(e) && "body" !== li(e)),
                      o = null,
                      l = "fixed" === ll(e).position,
                      i = l ? lM(e) : e;
                    for (; lc(i) && !lp(i); ) {
                      let e = ll(i),
                        t = lg(i);
            ...
            a = l.reduce((e, n) => {
              let r = lE(t, n, o);
              return (
                (e.top = lv(r.top, e.top)),
                (e.right = lm(r.right, e.right)),
                (e.bottom = lm(r.bottom, e.bottom)),
                (e.left = lv(r.left, e.left)),
                e
              );
            }, lE(t, i, o));
          return {
        ...
        convertOffsetParentRelativeRectToViewportRelativeRect: function (e) {
          ...
          if (
            (o || (!o && "fixed" !== r)) &&
            (("body" !== li(n) || lh(l)) && (i = lk(n)), ls(n))
          ) {
            let e = lx(n);
            (a = ly(n)), (s.x = e.x + n.clientLeft), (s.y = e.y + n.clientTop);
          }
          return {
            width: t.width * a.x,
            height: t.height * a.y,
        ...
        getDimensions: function (e) {
          if (ls(e)) return { width: e.offsetWidth, height: e.offsetHeight };
          let t = lx(e);
          return { width: t.width, height: t.height };
        },
        getOffsetParent: l$,
        getDocumentElement: lb,
        getScale: ly,
        getElementRects(e) {
          return _(this, null, function* () {
            let { reference: t, floating: n, strategy: r } = e,
              o = this.getOffsetParent || l$,
            ...
            return {
              ...
              floating: A({ x: 0, y: 0 }, yield l(n)),
            };
          });
        },
        getClientRects: (e) => Array.from(e.getClientRects()),
        isRTL: (e) => "rtl" === ll(e).direction,
      };
      function l_(e, t, n, r) {
        let o;
        void 0 === r && (r = {});
        ...
        if (a) {
          ...
          (d = new ResizeObserver(() => {
            ...
            lc(e) && !s && d.observe(e),
            lc(e) || !e.contextElement || s || d.observe(e.contextElement),
            d.observe(t);
        }
        let h = s ? lx(e) : null;
        return (
      ...
      let lR = (e, t, n) => {
          let r = new Map(),
            o = A({ platform: lT }, n),
            l = E(A({}, o.platform), { _c: r });
          return ln(e, t, E(A({}, o), { platform: l }));
        },
        lI = eI('<tc-root data-tc-dropdown-container="true"></tc-root>'),
        lH = () => {
          var e;
          let t;
          let n = e7(),
            ...
            p = (function (e, t, n) {
              let r = () => {
                  var e;
                  return null != (e = null == n ? void 0 : n.placement)
                    ? e
                    : "bottom";
                },
                o = () => {
                  var e;
                  return null != (e = null == n ? void 0 : n.strategy)
                    ? e
                    : "absolute";
                },
                [l, i] = F({
              ...
              return (
                z(() => {
                  let l = e(),
                    i = t();
                  if ((null == n || n.middleware, r(), o(), l && i)) {
                    if (null != n && n.whileElementsMounted) {
                      let e = n.whileElementsMounted(l, i, u);
                      e && Q(e);
                    } else u();
                  }
                }),
                {
                  ...
                  get middlewareData() {
                    return l().middlewareData;
                  },
                  update: u,
                }
              );
            })(g, d, { whileElementsMounted: l_, placement: "bottom-end" }),
            v = () => {
              let e = a();
              if (e) {
                let t = (0, m.mb)(e.address, e.chain === m.sX.TESTNET);
                return t.slice(0, 4) + "…" + t.slice(-4);
              }
              return "";
            };
          o.connectionRestored.then(() => u(!1));
          let C = r.onStatusChange((e) => {
              if (!e) {
                i(!1), s(null), u(!1);
                return;
              }
          ...
          return (
            ...
            z(() => G(e)),
            Q(() => {
              document.body.removeEventListener("click", w), C();
            }),
            ep(eq, {
              component: tr,
              get children() {
                  ...
                  get children() {
                    return [
                      ep(n1, {
                        ...
                        onInput: () => {
                          var t;
                          return null == (t = e.onSelectedTabIndexChange)
                            ? void 0
                            : t.call(e, 0);
                        },
                      }),
...
`;
      ...
      function lV(e) {
        return "jsBridgeKey" in e
          ? E(A({}, e), {
              injected: m.PS.isWalletInjected(e.jsBridgeKey),
              embedded: m.PS.isInsideWalletBrowser(e.jsBridgeKey),
            })
          : e;
      }
      function lD(e, t) {
        ...
        return (
          t &&
            ...
            ((r = "name"),
            (o = e),
            (l = t.includeWallets.map(lV)),
            (e = o
              .map((e) => {
                let t = l.find((t) => t[r] === e[r]);
                return (
                  (l = l.filter((t) => t[r] !== e[r])), void 0 === t ? e : t
                );
              })
              .concat(l))),
          e
      ...
      function lU(e) {
        return e.platforms.some((e) =>
          ["macos", "linux", "windows"].includes(e)
        );
      }
      function lK(e) {
...
`,
        ...
        lJ = (e) => {
          let t = () => (ok() ? void 0 : 510),
            n = () => (ok() ? e.walletsList.filter(lK) : e.walletsList);
          return ep(lZ, {
            "data-tc-wallets-modal-list": "true",
            get children() {
              return [
                ep(lY, { icon: "arrow", onClick: () => e.onBack() }),
                ep(lq, {
        ...
        lX = { m: "16px", s: "12px", none: "0" },
        l1 = { m: "6px", s: "6px", none: "0" },
        l0 = tt.div`
    display: flex;
    flex-direction: column;
`,
...
`,
      ...
      function ia(e, t) {
        let n = (function (e, t, n) {
          ...
          "string" == typeof t
            ? t
            : ni()
            ? t.twaReturnUrl || t.returnStrategy
            : "none"
        );
        if (!(0, m.dg)(e)) return n;
        let r = n.slice(n.lastIndexOf("&") + 1);
        return n.slice(0, n.lastIndexOf("&")) + "-" + (0, m.Ob)(r);
      }
      function is(e, t) {
        t = A({}, t);
        let n = new URL(
        ...
        if (
          (n.searchParams.has("startapp") ||
            n.searchParams.append("startapp", "tonconnect"),
          ni())
        )
          nl("ios", "android", "macos")
          ...
          if ((e || r) && !t.forceRedirect) {
            let e = ia(n.toString(), t.returnStrategy);
            tf(iu(e), () => tg(e));
          } else tg(ia(n.toString(), t.returnStrategy));
        } else if (tw("android")) {
        ...
        } else if (tw("macos", "windows", "linux")) {
          if (
            ((t.returnStrategy = "none"),
            (t.twaReturnUrl = void 0),
            t.forceRedirect)
            ...
            let e = ia(n.toString(), t);
            tf(iu(e), () => tg(e));
          }
        } else tg(ia(n.toString(), t));
      }
      function ic(e, t, n, r) {
        if (((n = A({}, n)), ni())) {
          if (nl("ios", "android")) {
            "back" === n.returnStrategy && (n.returnStrategy = "tg://resolve"),
              r("universal-link");
            let t = ia(e, n.returnStrategy);
            ns(t, () => {
              r("universal-link"), tg(t);
            });
          } else if (nl("macos", "tdesktop")) {
            "back" === n.returnStrategy && (n.returnStrategy = "tg://resolve");
            let o = ia(e, n.returnStrategy);
            t && !n.forceRedirect
              ? (r("custom-deeplink"),
                tf(tx(o, t), () => {
                  r("universal-link"), tg(o);
                }))
              : (r("universal-link"), tg(o));
          } else if (nl("weba")) {
            ...
            t && !n.forceRedirect
              ...
              : (r("universal-link"), tg(o));
          } else r("universal-link"), tg(ia(e, n.returnStrategy));
        } else if (tw("ios"))
          "back" === n.returnStrategy &&
            (ty("safari")
              ...
              : (n.returnStrategy = location.href)),
            ty("chrome")
              ? (r("universal-link"), th(ia(e, n.returnStrategy), "_self"))
              : (r("universal-link"), tg(ia(e, n.returnStrategy)));
        else if (tw("android"))
          "back" === n.returnStrategy &&
            (ty("chrome")
              ? (n.returnStrategy = "googlechrome://")
      ...
      let id = (e) => {
          ...
          z(() => {
            "extension" !== G(t) && (lK(e.wallet) || lU(e.wallet)) && u();
          });
          let d = () => {
              o(!1),
                "extension" === t() && u(),
                n("mobile"),
                tW(E(A({}, e.wallet), { openMethod: "qrcode" }));
            },
            h = () => {
              ...
              s(!1),
                ic(
                  l(),
                  e.wallet.deepLink,
                  { returnStrategy: lN.returnStrategy, forceRedirect: r },
                  (t) => {
                    tW(E(A({}, e.wallet), { openMethod: t }));
                  }
                );
            },
            g = () => {
              let t = !a();
              s(!1),
                tW(E(A({}, e.wallet), { openMethod: "universal-link" })),
                is(l(), {
                  returnStrategy: lN.returnStrategy,
                  twaReturnUrl: lN.twaReturnUrl,
                  forceRedirect: t,
                });
            },
            f = () => {
                ...
                return [
                  ...
                  ep(eb, {
                    ...
                    get children() {
                      return ep(l3, {
                        translationKey:
                          "walletModal.desktopConnectionModal.scanQR",
                        get translationValues() {
...
`,
        ix = (e) =>
          ep(ih, {
            ...
            get children() {
              return [
                ep(ig, { icon: "arrow", onClick: () => e.onBackClick() }),
                ep(ip, {
                      ...
                      ep(im, {
                        get children() {
                          return [
                            ...
                            ep(iw, {
                              translationKey:
                                "walletModal.infoModal.walletProtects",
                              children:
                      ...
                      ep(im, {
                        get children() {
                          return [
                            ...
                            ep(iC, {
                              translationKey:
                                "walletModal.infoModal.controlIdentity",
                              children: "Control your Web3 identity",
                            }),
                            ep(iw, {
                              translationKey:
                                "walletModal.infoModal.manageIdentity",
                              children:
                      ...
                      ep(im, {
                        get children() {
                          return [
                            ...
                            ep(iw, {
                              translationKey:
                                "walletModal.infoModal.easilySend",
                              children:
...
`,
    ...
    align-items: center;
    gap: 12px;
    border-top: 0.5px solid ${(e) => ta(e.theme.colors.icon.secondary, 0.2)};
`,
        i$ = tt(nt)`
    width: 36px;
    height: 36px;
...
`,
          ...
          ep(iW, {
            get children() {
              return ep(ro, {
                ...
                get sourceUrl() {
                  return ia(e.universalLink, "none");
                },
                disableCopy: !0,
              });
            },
        ...
        iP = (e) => {
          let t = e7(),
            ...
            h = () => {
              ...
              r(!1),
                ic(
                  u(),
                  e.wallet.deepLink,
                  { returnStrategy: lN.returnStrategy, forceRedirect: o },
                  (t) => {
                    tW(E(A({}, e.wallet), { openMethod: t }));
                  }
                );
            ...
            g = () => {
              a(!1), l(!0), tW(E(A({}, e.wallet), { openMethod: "qrcode" }));
            },
            f = () => {
              l(!1), tW(E(A({}, e.wallet), { openMethod: "universal-link" }));
            },
            p = () => {
              o() ? f() : e.onBackClick();
            };
              ...
              get children() {
                return [
                  ep(eb, {
                    ...
                    get children() {
                      return ep(iM, { icon: "arrow", onClick: p });
                    },
                  }),
                  ep(eb, {
                    get when() {
        ...
        iN = { m: "16px", s: "12px", none: "0" },
        iO = { m: "6px", s: "6px", none: "0" },
        iV = tt.ul`
    display: flex;
    justify-content: space-between;
    margin: 0 auto;
...
`,
      ...
      function iX(e) {
        return Array.from(new Set(e.filter(m.Lh).map((e) => e.bridgeUrl))).map(
          (e) => ({ bridgeUrl: e })
        );
      }
      function i1(e, t) {
      ...
      let i0 = eI("<li></li>"),
        i2 = eI('<div data-tc-wallets-modal-universal-mobile="true"></div>'),
        i5 = (e) => {
          let [t, n] = F(!1),
            [r, o] = F(!0),
            [l, i] = F(null),
            a = lN.connector,
            s = () => e.walletsList.filter((e) => lK(e) && e.appName !== om),
            c = () => s().length > 7,
            u = Y(() => iX(e.walletsList), null, { equals: i1 }),
            d = () => (l() || i(a.connect(u(), e.additionalRequest)), l());
          tW({ openMethod: "universal-link" });
          let [h, g] = F(void 0),
            f = () =>
              _(void 0, null, function* () {
                void 0 !== h() && clearTimeout(h()), yield rn(d());
                let e = setTimeout(() => g(void 0), 1500);
                g(e);
              }),
            p = () => {
              let e = !r();
              o(!1),
                ic(
                  d(),
                  void 0,
                  { returnStrategy: lN.returnStrategy, forceRedirect: e },
                  (e) => {
                    tW({ openMethod: e });
                  }
                );
            ...
            v = () => {
              i(null);
              let t = e.walletsList.find((e) => e.appName === om);
              if (!t || !(0, m.Lh)(t))
                throw new tu("@wallet bot not found in the wallets list");
              let n = a.connect(
                  { bridgeUrl: t.bridgeUrl, universalLink: t.universalLink },
                  e.additionalRequest
                ),
                l = !r();
              o(!1),
            ...
            C = () => {
              n(!0), tW({ openMethod: "qrcode" });
            },
            w = () => {
              n(!1), tW({ openMethod: "universal-link" });
            };
          return (() => {
            let n = i2.cloneNode(!0);
            return (
              eN(
                n,
                ep(eb, {
        ...
        i4 = { m: "16px", s: "8px", none: "0" },
        i3 = { m: "8px", s: "4px", none: "0" },
        i9 = tt.div`
    display: flex;
    flex-direction: column;
    align-items: center;
...
`;
      let at = eI("<li></li>"),
        an = (e) => {
          let [t, n] = F(!1),
            r = lN.connector,
            o = Y(() => iX(e.walletsList), null, { equals: i1 });
          tW({ openMethod: "qrcode" });
          let l = Y(() => r.connect(o(), e.additionalRequest));
          return ep(i9, {
            onClick: () => n(!1),
        ...
        ar = () => {
          ...
          z(() => e(lN.language)),
            z(() => {
              t$() ? oM() : (i(null), s("universal"), u(!1));
            });
          let t = X(tV),
            n = X(oE),
            [o] = (function (e, t, n) {
              let o, l, i;
              (2 == arguments.length && "object" == typeof t) ||
              1 == arguments.length
                ? ((o = !0), (l = e), (i = t || {}))
                : ((o = e), (l = t), (i = n || {}));
              let a = null,
                ...
                u = !1,
                d = "initialValue" in i,
                h = "function" == typeof o && Y(o),
                g = new Set(),
                [f, p] = (i.storage || F)(i.initialValue),
                [m, v] = F(void 0),
                [C, w] = F(void 0, { equals: !1 }),
                [y, x] = F(d ? "ready" : "unresolved");
              if (R.context) {
                let e;
                (c = `${R.context.id}${R.context.count++}`),
                  "initial" === i.ssrLoadFrom
                    ? (s = i.initialValue)
                    : R.load && (e = R.load(c)) && (s = e[0]);
              }
              function b(e, t, n, r) {
                return (
                  a === e &&
                    ...
                    (s = N),
                    ei(() => {
                      for (let e of (void 0 === n && p(() => t),
                      x(void 0 !== n ? "errored" : "ready"),
                      v(n),
                      g.keys()))
                        e.decrement();
                      g.clear();
                ...
                return (
                  V &&
                    ...
                    Z(() => {
                      C(),
                        a &&
                          (r.resolved || g.has(r) || (r.increment(), g.add(r)));
                    }),
                  e
                );
              }
              function S(e = !0) {
                ...
                let n =
                  s !== N ? s : G(() => l(t, { value: f(), refetching: e }));
            ...
            d = Y(() => {
              ...
              let e = lD(o(), lN.walletsListConfiguration),
                t = e.filter(m.rM),
                n = e.filter((e) => !(0, m.rM)(e));
              e = (t || []).concat(n);
              let r = lN.preferredWalletAppName,
                l = e.find((e) => lF(e, r)),
                i = e.filter((e) => lF(e, r)).length >= 2;
              r &&
                l &&
                !i &&
                (e = [E(A({}, l), { isPreferred: !0 })].concat(
                  e.filter((e) => !lF(e, r))
                ));
              let a = e.find((e) => lF(e, om));
              return a && (e = [a].concat(e.filter((e) => !lF(e, om)))), e;
            }),
            h = () => {
              var e;
              return (
                (null == (e = lN.connectRequestParameters)
                  ? void 0
                  : e.state) === "loading"
              );
            },
            g = Y(() => {
              var e;
              if (!h())
                return null == (e = lN.connectRequestParameters)
                  ? void 0
                  : e.value;
            }),
            f = (e) => {
          ...
          return (
            ...
            ep(lW, {
              ...
              get enableAndroidBackHandler() {
                return lN.enableAndroidBackHandler;
              },
...
`,
        au = (e) => {
          ...
          z(() => {
            ...
            (null == o ? void 0 : o.wallet) &&
              "universalLink" in o.wallet &&
              ("universal-link" === o.wallet.openMethod ||
                ((0, m.dg)(o.wallet.universalLink) && ni())) &&
              (t = o.wallet.universalLink),
            (null == o ? void 0 : o.wallet) &&
              "deepLink" in o.wallet &&
              ("custom-deeplink" === o.wallet.openMethod ||
                ((0, m.dg)(o.wallet.deepLink) && ni())) &&
              (n = o.wallet.deepLink);
          let c = () => {
            let e = tB(),
              r = "returnStrategy" in e ? e.returnStrategy : lN.returnStrategy,
              o = !l();
            i(!1),
              (0, m.dg)(t)
                ? is(t, {
                    returnStrategy: r,
                    twaReturnUrl:
                      "twaReturnUrl" in e ? e.twaReturnUrl : lN.twaReturnUrl,
                    forceRedirect: o,
                  })
                : ic(t, n, { returnStrategy: r, forceRedirect: o }, () => {});
          };
          return ep(
            ao,
            ew(r, {
                ...
                return [
                  ...
                  ep(eb, {
                    get when() {
                      return (
                        !a() &&
                        (("open-wallet" === e.showButton && t) ||
                          "open-wallet" !== e.showButton)
                      );
                    },
                    get children() {
                      return ep(aa, {
        ...
        af = () =>
          ep(nY, {
            get opened() {
              ...
              return (
                Y(() => null !== tB())() &&
                (null == (e = tB()) ? void 0 : e.openModal) === !0
              );
            },
            get enableAndroidBackHandler() {
              return lN.enableAndroidBackHandler;
              ...
              return ep(ek, {
                get children() {
                  return [
                    ep(eS, {
                      get when() {
                        return "transaction-sent" === tB().name;
                      },
                      get children() {
                        return ep(ag, { onClose: () => tP(null) });
                      },
                    }),
                    ep(eS, {
                      get when() {
                        return "transaction-canceled" === tB().name;
                      },
                      get children() {
                        return ep(ah, { onClose: () => tP(null) });
                      },
                    }),
                    ep(eS, {
                      get when() {
                        return "confirm-transaction" === tB().name;
                      },
                      get children() {
                        return ep(ad, { onClose: () => tP(null) });
                      },
                    }),
                  ];
                },
        ...
        am = (e) => {
          let t = ra(tN, lN.language);
          return (
            customElements.define(tr, class extends HTMLElement {}),
            document.body.hasAttribute("ontouchstart") ||
              document.body.setAttribute("ontouchstart", ""),
            ep(rs.Provider, {
              value: t,
              get children() {
                return ep(oE.Provider, {
                  get value() {
                    return e.tonConnectUI;
                  },
                  get children() {
                    return ep(tV.Provider, {
                      get value() {
                        return lN.connector;
                      },
                      get children() {
        ...
        av = {
          openWalletsModal: () =>
            void setTimeout(() => tL({ status: "opened", closeReason: null })),
          closeWalletsModal: (e) =>
            void setTimeout(() => tL({ status: "closed", closeReason: e })),
          openSingleWalletModal: (e) => {
            setTimeout(() =>
              tE({ status: "opened", closeReason: null, walletInfo: e })
            );
          },
          closeSingleWalletModal: (e) =>
            void setTimeout(() => tE({ status: "closed", closeReason: e })),
          setAction: (e) => void setTimeout(() => tP(e)),
          clearAction: () => void setTimeout(() => tP(null)),
          getSelectedWalletInfo: () => tI(),
          removeSelectedWalletInfo: () => tW(null),
          renderApp: (e, t) =>
            (function (e, t, n, r = {}) {
              let o;
              return (
                j((n) => {
                  (o = n),
                    t === document
                      ? e()
                      : eN(t, e(), t.firstChild ? null : void 0, void 0);
                }, r.owner),
                () => {
                  o(), (t.textContent = "");
                }
              );
            })(() => ep(am, { tonConnectUI: t }), document.getElementById(e)),
        };
      class aC {
        constructor(e) {
          T(this, "connector"),
            T(this, "setConnectRequestParametersCallback"),
            T(this, "consumers", []),
            T(this, "tracker"),
            T(this, "state", tM()),
            ...
            (this.setConnectRequestParametersCallback =
              e.setConnectRequestParametersCallback),
            z(() => {
              let e = tM();
        ...
        open() {
          return _(this, null, function* () {
            ...
            let e = (yield this.connector.getWallets()).find(m.eo);
        ...
        connectEmbeddedWallet(e) {
          let t = (t) => {
              tW(e), this.connector.connect({ jsBridgeKey: e.jsBridgeKey }, t);
            },
            n = lN.connectRequestParameters;
      ...
      class ay {
        ...
        open(e) {
          return _(this, null, function* () {
            this.tracker.trackConnectionStarted();
            let t = lD(
                yield this.connector.getWallets(),
                lN.walletsListConfiguration
              ),
              n = t.find(m.eo);
            if (n) return this.connectEmbeddedWallet(n);
            let r = t.filter(m.Lh).find((t) => lF(t, e));
            if (r) return this.openSingleWalletModal(r);
            let o = `Trying to open modal window with unknown wallet "${e}".`;
            throw (this.tracker.trackConnectionError(o), new tu(o));
          });
        }
        close(e = "action-cancelled") {
          "action-cancelled" === e &&
            this.tracker.trackConnectionError("Connection was cancelled"),
            av.closeSingleWalletModal("action-cancelled");
        }
        onStateChange(e) {
          return (
            this.consumers.push(e),
      ...
      class ax {
        constructor(e) {
          var t;
          T(this, "eventPrefix", "ton-connect-ui-"),
            T(this, "tonConnectUiVersion"),
            T(this, "tonConnectSdkVersion", null),
            T(this, "eventDispatcher"),
            (this.eventDispatcher =
              null != (t = null == e ? void 0 : e.eventDispatcher)
                ? t
                : new m.Rh()),
              ...
              () =>
                _(this, null, function* () {
                  yield this.eventDispatcher.dispatchEvent(
                    ...
                    (0, m.Ls)(this.tonConnectUiVersion)
                  );
                })
            );
          });
        ...
        dispatchUserActionEvent(e) {
          var t;
          try {
            null == (t = this.eventDispatcher) ||
              t.dispatchEvent(`${this.eventPrefix}${e.type}`, e).catch();
          } catch (e) {}
        }
        trackConnectionStarted(...e) {
          try {
            let t = (0, m.DW)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackConnectionCompleted(...e) {
          try {
            let t = (0, m.Yz)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackConnectionError(...e) {
          try {
            let t = (0, m.D)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackConnectionRestoringStarted(...e) {
          try {
            let t = (0, m.gW)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackConnectionRestoringCompleted(...e) {
          try {
            let t = (0, m.NO)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackConnectionRestoringError(...e) {
          try {
            let t = (0, m.e6)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackDisconnection(...e) {
          try {
            let t = (0, m._6)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackTransactionSentForSignature(...e) {
          try {
            let t = (0, m.PT)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackTransactionSigned(...e) {
          try {
            let t = (0, m.h1)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
        trackTransactionSigningFailed(...e) {
          try {
            let t = (0, m.Ey)(this.version, ...e);
            this.dispatchUserActionEvent(t);
          } catch (e) {}
        }
      }
      class ab {
        constructor(e) {
          if (
            (T(this, "walletInfoStorage", new tb()),
            T(this, "preferredWalletStorage", new tk()),
            T(this, "tracker"),
            T(this, "walletInfo", null),
            T(this, "systemThemeChangeUnsubscribe", null),
            T(this, "actionsConfiguration"),
            T(this, "walletsList"),
            T(this, "connectRequestParametersCallback"),
            T(this, "connector"),
            T(this, "modal"),
            T(this, "singleWalletModal"),
            T(this, "transactionModal"),
            T(this, "connectionRestored", Promise.resolve(!1)),
            e && "connector" in e && e.connector)
          )
            this.connector = e.connector;
          else if (e && "manifestUrl" in e && e.manifestUrl)
            this.connector = new m.PS({
          ...
          (this.tracker = new ax({
            ...
            (this.transactionModal = new aw({ connector: this.connector })),
            (this.walletsList = this.getWallets()),
            this.walletsList.then((e) =>
              (function e(t) {
                "complete" !== document.readyState
                  ? window.addEventListener("load", () => tp(() => e(t)), {
                      once: !0,
                    })
                  : t.forEach((e) => {
          ...
          this.subscribeToWalletChange(),
            ...
            (this.uiOptions = t4(e, { uiPreferences: { theme: "SYSTEM" } }));
          let n = this.preferredWalletStorage.getPreferredWalletAppName();
          lO({ connector: this.connector, preferredWalletAppName: n }),
            av.renderApp(t, this);
        }
        static getWallets() {
          return m.PS.getWallets();
        }
        get connected() {
        ...
        get wallet() {
          return this.connector.wallet
            ? A(A({}, this.connector.wallet), this.walletInfo)
            : null;
        }
        set uiOptions(e) {
          var t, n, r, o, l, i;
          ...
          null == (t = e.uiPreferences) ? void 0 : t.theme)
            ? (null == (n = e.uiPreferences) ? void 0 : n.theme) !== "SYSTEM"
              ? (null == (r = this.systemThemeChangeUnsubscribe) ||
                  r.call(this),
                t7(e.uiPreferences.theme, e.uiPreferences.colorsSet))
              : (t7(
                  window.matchMedia &&
                ...
                this.systemThemeChangeUnsubscribe ||
                  (this.systemThemeChangeUnsubscribe = (function (e) {
                    let t = (t) => e(t.matches ? ez.DARK : ez.LIGHT);
                    return (
                      window
            ...
            : (null == (o = e.uiPreferences) ? void 0 : o.colorsSet) &&
              ((i = e.uiPreferences.colorsSet),
              (t6[ez.DARK] = t4(i[ez.DARK], t6[ez.DARK])),
              (t6[ez.LIGHT] = t4(i[ez.LIGHT], t6[ez.LIGHT])),
              t9((e) => ({ colors: t4(t6[e.theme], t8[e.theme]) }))),
            (null == (l = e.uiPreferences) ? void 0 : l.borderRadius) &&
              t9({ borderRadius: e.uiPreferences.borderRadius }),
            lO((t) => {
              var n, r;
              let o = t4(
                A(
                  A(
                    A(
                      A({}, e.language && { language: e.language }),
                      !!(null == (n = e.actionsConfiguration)
                        ? void 0
                        : n.returnStrategy) && {
                        returnStrategy: e.actionsConfiguration.returnStrategy,
                      }
                    ),
                    !!(null == (r = e.actionsConfiguration)
                      ? void 0
                      : r.twaReturnUrl) && {
        ...
        connectWallet() {
          return _(this, null, function* () {
            let e = (yield this.getWallets()).find(m.eo);
            return e
              ? yield this.connectEmbeddedWallet(e)
          ...
          return _(this, null, function* () {
            if (
              ...
              throw (
                ...
                new tu("Connect wallet to send a transaction."))
              );
            ni() && na();
            let {
              notifications: n,
            ...
            try {
                ...
                () => {
                  !a.signal.aborted &&
                    ...
                    this.walletInfo &&
                      ...
                      ((0, m.dg)(this.walletInfo.universalLink)
                        ? is(this.walletInfo.universalLink, {
                            returnStrategy: o,
                            twaReturnUrl: l || lN.twaReturnUrl,
                            forceRedirect: !1,
                          })
                        : ic(
                            this.walletInfo.universalLink,
                            this.walletInfo.deepLink,
                            { returnStrategy: o, forceRedirect: !1 },
                            () => {}
                          )));
                }
              );
              ...
              if (
                ...
                throw e;
              throw (console.error(e), new tu("Unhandled error:" + e));
            } finally {
              s();
            }
          });
        ...
        connectEmbeddedWallet(e) {
          return _(this, null, function* () {
            let t = (t) => {
                tW(e),
                  this.connector.connect({ jsBridgeKey: e.jsBridgeKey }, t);
              },
              n = lN.connectRequestParameters;
            return (
              (null == n ? void 0 : n.state) === "loading"
        ...
        waitForWalletConnection(e) {
          return _(this, null, function* () {
            return new Promise((t, n) => {
              this.tracker.trackConnectionStarted();
              let { ignoreErrors: r = !1, signal: o = null } = e;
              if (o && o.aborted)
                return (
                  this.tracker.trackConnectionError("Connection was cancelled"),
                  n(new tu("Wallet was not connected"))
                );
              let l = (e) =>
                  _(this, null, function* () {
            ...
            return new Promise((n, r) => {
              ...
              if (l.aborted)
                return (
                  ...
                  r(new tu("Transaction was not sent"))
                );
              let i = (e) =>
                  _(this, null, function* () {
                    n(e);
              ...
              l.addEventListener("abort", s, { once: !0 }),
                this.connector
                  .sendTransaction(o, { onRequestSent: t, signal: l })
                  .then((e) => (l.removeEventListener("abort", s), i(e)))
                  .catch((e) => (l.removeEventListener("abort", s), a(e)));
            });
          });
        }
              ...
              e
                ? (yield this.updateWalletInfo(e),
                  this.setPreferredWalletAppName(
                    (null == (t = this.walletInfo) ? void 0 : t.appName) ||
                      e.device.appName
                  ))
                : this.walletInfoStorage.removeWalletInfo();
            })
        ...
        setPreferredWalletAppName(e) {
          this.preferredWalletStorage.setPreferredWalletAppName(e),
            lO({ preferredWalletAppName: e });
        }
        getSelectedWalletInfo(e) {
          return _(this, null, function* () {
            let t,
              n = av.getSelectedWalletInfo();
            if (!n) return null;
            if ("name" in n) t = n;
            else {
              let r = lD(
                ...
                lN.walletsListConfiguration
              ).find((t) => lF(t, e.device.appName));
              if (!r)
                throw new tu(
                  `Cannot find WalletInfo for the '${e.device.appName}' wallet`
                );
              t = A(A({}, r), n);
            }
            return t;
        ...
        updateWalletInfo(e) {
          return _(this, null, function* () {
            ...
            this.walletInfo =
              (yield this.walletsList).find((t) => lF(t, e.device.appName)) ||
              null;
          });
        }
        ...
        checkButtonRootExist(e) {
          if (null != e && !document.getElementById(e))
            throw new tu(`${e} element not found in the document.`);
        }
        getModalsAndNotificationsConfiguration(e) {
          var t, n, r, o, l, i;
          let a = ["before", "success", "error"],
            s = a;
          (null == (t = this.actionsConfiguration)
            ? void 0
            : t.notifications) &&
            (null == (n = this.actionsConfiguration)
              ? void 0
              : n.notifications) !== "all" &&
            (s = this.actionsConfiguration.notifications),
            (null == e ? void 0 : e.notifications) &&
              (s = "all" === e.notifications ? a : e.notifications);
          let c = ["before"];
          (null == (r = this.actionsConfiguration) ? void 0 : r.modals) &&
            (c =
              "all" === this.actionsConfiguration.modals
                ? a
                : this.actionsConfiguration.modals),
            (null == e ? void 0 : e.modals) &&
              (c = "all" === e.modals ? a : e.modals);
          let u =
              (null == e ? void 0 : e.returnStrategy) ||
              (null == (o = this.actionsConfiguration)
                ? void 0
                : o.returnStrategy) ||
              "back",
            d =
              (null == e ? void 0 : e.twaReturnUrl) ||
              (null == (l = this.actionsConfiguration)
                ? void 0
                : l.twaReturnUrl),
            h =
              (null == e ? void 0 : e.skipRedirectToWallet) ||
              (null == (i = this.actionsConfiguration)
                ? void 0
                : i.skipRedirectToWallet) ||
              "ios";
          return (
            ni() && (h = "never"),
            {
